...
class KEE_Home_Slider_Kintaelectic_Widget extends \Elementor\Widget_Base {
    ...
    protected function register_controls() {
        ...
        $repeater->add_control(
            'price_from',
            [
                'label' => esc_html__('Precio Desde', 'kinta-electric-elementor'),
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => esc_html__('749', 'kinta-electric-elementor'),
            ]
        );
        ...
        $repeater->add_control(
            'price_cents',
            [
                'label' => esc_html__('Centavos del Precio', 'kinta-electric-elementor'),
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => esc_html__('99', 'kinta-electric-elementor'),
            ]
        );
        ...
        $repeater->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => esc_html__('Start Buying', 'kinta-electric-elementor'),
            ]
        );
            ...
            [
                ...
                'default' => [
                    [
                        ...
                        'price' => esc_html__('749', 'kinta-electric-elementor'),
                        'button_text' => esc_html__('Start Buying', 'kinta-electric-elementor'),
                        'button_url' => ['url' => '#'],
                    ],
                ],
                'title_field' => '{{{ title }}}',
