...
class WVP_Gateway_Efectivo extends WC_Payment_Gateway {
    ...
    public function validate_fields() {
        ...
        if (!WVP_Security_Validator::validate_nonce($_POST['woocommerce-process-checkout-nonce'] ?? '', 'woocommerce-process_checkout')) {
            ...
            WVP_Security_Validator::log_security_event("CSRF validation failed in Efectivo USD gateway");
            return false;
        }
        ...
        if (!WVP_Security_Validator::validate_user_permissions()) {
            ...
            WVP_Security_Validator::log_security_event("User permission validation failed in Efectivo USD gateway");
            return false;
        }
    ...
    public function process_payment($order_id) {
        try {
            ...
            // 15. Limpiar rate limit en caso de éxito
