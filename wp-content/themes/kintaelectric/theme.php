...
final class Theme {
	...
	public function autoload( $class_name ) {
		...
		if ( ! class_exists( $class_to_load ) ) {
			...
			$filename = trailingslashit( kintaelectric_PATH ) . $filename . '.php';
	...
	public function activate() {
		do_action( 'kintaelectric-theme/after_switch_theme' );
	}

	public function redirect_on_first_activation() {
		do_action( 'kintaelectric-theme/redirect_on_first_activation' );
	}
