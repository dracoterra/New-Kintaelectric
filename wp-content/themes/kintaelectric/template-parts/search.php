...
<main id="content" class="site-main">
	...
	<div class="page-content">
		<?php
		if ( apply_filters( 'kintaelectric-theme/page_title', true ) ) :
			?>
		...
		<div class="posts-container">
			...
			if ( have_posts() ) :
				...
				?>
				<p>
					<?php echo esc_html__( 'It seems we can\'t find what you\'re looking for.', 'kintaelectric' ); ?>
				</p>
			<?php endif; ?>
		</div>
		<?php
