...
<header id="masthead" class="site-header header-v1 stick-this">
	...
	<div class="container hidden-lg-down d-none d-xl-block">
		<div class="masthead row align-items-center">
					...
					<div class="off-canvas-navigation light" id="default-oc-header">
						...
						wp_nav_menu(
							array(
								...
								'menu_id'        => 'menu-all-departments-menu',
								'container'      => false,
								'menu_class'     => 'nav nav-inline yamm',
								'fallback_cb'    => function() {
									echo '<ul class="nav nav-inline yamm">';
									echo '<li class="highlight menu-item"><a href="' . esc_url( home_url( '/home-v2' ) ) . '">' . esc_html__( 'Value of the Day', 'kintaelectric' ) . '</a></li>';
									echo '<li class="highlight menu-item"><a href="' . esc_url( home_url( '/home-v3' ) ) . '">' . esc_html__( 'Top 100 Offers', 'kintaelectric' ) . '</a></li>';
									echo '<li class="highlight menu-item"><a href="' . esc_url( home_url( '/home-v3-full-color-background' ) ) . '">' . esc_html__( 'New Arrivals', 'kintaelectric' ) . '</a></li>';
									echo '<li class="yamm-tfw menu-item dropdown"><a href="#" data-bs-toggle="dropdown" class="dropdown-toggle">' . esc_html__( 'Computers & Accessories', 'kintaelectric' ) . '</a></li>';
									echo '<li class="yamm-tfw menu-item dropdown"><a href="#" data-bs-toggle="dropdown" class="dropdown-toggle">' . esc_html__( 'Cameras, Audio & Video', 'kintaelectric' ) . '</a></li>';
									echo '<li class="yamm-tfw menu-item dropdown"><a href="#" data-bs-toggle="dropdown" class="dropdown-toggle">' . esc_html__( 'Mobiles & Tablets', 'kintaelectric' ) . '</a></li>';
									echo '<li class="yamm-tfw menu-item dropdown"><a href="#" data-bs-toggle="dropdown" class="dropdown-toggle">' . esc_html__( 'Movies, Music & Video Games', 'kintaelectric' ) . '</a></li>';
									echo '<li class="yamm-tfw menu-item dropdown"><a href="#" data-bs-toggle="dropdown" class="dropdown-toggle">' . esc_html__( 'TV & Audio', 'kintaelectric' ) . '</a></li>';
									echo '<li class="yamm-tfw menu-item dropdown"><a href="#" data-bs-toggle="dropdown" class="dropdown-toggle">' . esc_html__( 'Watches & Eyewear', 'kintaelectric' ) . '</a></li>';
									echo '<li class="yamm-tfw menu-item dropdown"><a href="#" data-bs-toggle="dropdown" class="dropdown-toggle">' . esc_html__( 'Car, Motorbike & Industrial', 'kintaelectric' ) . '</a></li>';
									echo '<li class="menu-item dropdown"><a href="#" data-bs-toggle="dropdown" class="dropdown-toggle">' . esc_html__( 'Accessories', 'kintaelectric' ) . '</a></li>';
									echo '</ul>';
								},
							)
						);
			...
			<form class="navbar-search col" method="get" action="<?php echo esc_url( home_url( '/' ) ); ?>" autocomplete="off">
				...
				<div class="input-group">
					<div class="input-search-field">
						<input type="text" id="search" class="form-control search-field product-search-field" dir="ltr" value="" name="s" placeholder="<?php esc_attr_e( 'Search for Products', 'kintaelectric' ); ?>" autocomplete="off">
					</div>
							...
							if ( class_exists( 'WooCommerce' ) ) {
								...
								if ( ! empty( $product_categories ) && ! is_wp_error( $product_categories ) ) {
									foreach ( $product_categories as $category ) {
										echo '<option class="level-0" value="' . esc_attr( $category->slug ) . '">' . esc_html( $category->name ) . '</option>';
									}
								}
							}
							?>
			...
			<div class="header-icons col-auto d-flex justify-content-end align-items-center">
				...
				<div style="position: relative;" class="header-icon" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="<?php esc_attr_e( 'Compare', 'kintaelectric' ); ?>">
					<a href="<?php echo esc_url( home_url( '/compare' ) ); ?>" class="yith-woocompare-open">
							...
							<div class="register-sign-in-dropdown-inner">
								<div class="sign-in">
									...
									<div class="sign-in-action">
										<a href="<?php echo esc_url( wc_get_page_permalink( 'myaccount' ) ); ?>" class="sign-in-button"><?php esc_html_e( 'Sign in', 'kintaelectric' ); ?></a>
									</div>
								</div>
								<div class="register">
									<p><?php esc_html_e( 'Don\'t have an account ?', 'kintaelectric' ); ?></p>
									<div class="register-action">
										<a href="<?php echo esc_url( wc_get_page_permalink( 'myaccount' ) ); ?>"><?php esc_html_e( 'Register', 'kintaelectric' ); ?></a>
									</div>
								</div>
							</div>
						</li>
		...
		<!-- Secondary Navigation - IMPORTANT STRUCTURE OMITTED -->
		<div class="electro-navigation row yes-home">
			<div class="departments-menu-v2">
				<div class="dropdown show-dropdown">
					<a href="#" class="departments-menu-v2-title">
						<span><i class="departments-menu-v2-icon fa fa-list-ul"></i><?php esc_html_e( 'All Departments', 'kintaelectric' ); ?></span>
					</a>
					<?php
					wp_nav_menu(
						array(
							'theme_location' => 'all-departments',
							'menu_id'        => 'menu-all-departments-menu-1',
							'container'      => false,
							'menu_class'     => 'dropdown-menu yamm',
							'fallback_cb'    => function() {
								echo '<ul class="dropdown-menu yamm">';
								echo '<li class="highlight menu-item"><a href="' . esc_url( home_url( '/home-v2' ) ) . '">' . esc_html__( 'Value of the Day', 'kintaelectric' ) . '</a></li>';
								echo '<li class="highlight menu-item"><a href="' . esc_url( home_url( '/home-v3' ) ) . '">' . esc_html__( 'Top 100 Offers', 'kintaelectric' ) . '</a></li>';
								echo '<li class="highlight menu-item"><a href="' . esc_url( home_url( '/home-v3-full-color-background' ) ) . '">' . esc_html__( 'New Arrivals', 'kintaelectric' ) . '</a></li>';
								echo '<li class="yamm-tfw menu-item dropdown"><a href="#" data-bs-toggle="dropdown-hover" class="dropdown-toggle">' . esc_html__( 'Computers & Accessories', 'kintaelectric' ) . '</a></li>';
								echo '<li class="yamm-tfw menu-item dropdown"><a href="#" data-bs-toggle="dropdown-hover" class="dropdown-toggle">' . esc_html__( 'Cameras, Audio & Video', 'kintaelectric' ) . '</a></li>';
								echo '<li class="yamm-tfw menu-item dropdown"><a href="#" data-bs-toggle="dropdown-hover" class="dropdown-toggle">' . esc_html__( 'Mobiles & Tablets', 'kintaelectric' ) . '</a></li>';
								echo '<li class="yamm-tfw menu-item dropdown"><a href="#" data-bs-toggle="dropdown-hover" class="dropdown-toggle">' . esc_html__( 'Movies, Music & Video Games', 'kintaelectric' ) . '</a></li>';
								echo '<li class="yamm-tfw menu-item dropdown"><a href="#" data-bs-toggle="dropdown-hover" class="dropdown-toggle">' . esc_html__( 'TV & Audio', 'kintaelectric' ) . '</a></li>';
								echo '<li class="yamm-tfw menu-item dropdown"><a href="#" data-bs-toggle="dropdown-hover" class="dropdown-toggle">' . esc_html__( 'Watches & Eyewear', 'kintaelectric' ) . '</a></li>';
								echo '<li class="yamm-tfw menu-item dropdown"><a href="#" data-bs-toggle="dropdown-hover" class="dropdown-toggle">' . esc_html__( 'Car, Motorbike & Industrial', 'kintaelectric' ) . '</a></li>';
								echo '<li class="menu-item dropdown"><a href="#" data-bs-toggle="dropdown-hover" class="dropdown-toggle">' . esc_html__( 'Accessories', 'kintaelectric' ) . '</a></li>';
								echo '</ul>';
							},
						)
					);
	...
	<!-- Mobile Header - IMPORTANT STRUCTURE OMITTED -->
		...
		<div class="handheld-header-v2 row align-items-center handheld-stick-this">
			...
			<div class="off-canvas-navigation-wrapper">
				...
				<div class="off-canvas-navigation light" id="default-oc-header">
					...
					wp_nav_menu(
						array(
							'theme_location' => 'all-departments',
							'menu_id'        => 'menu-all-departments-menu-2',
							'container'      => false,
							'menu_class'     => 'nav nav-inline yamm',
							'fallback_cb'    => function() {
								echo '<ul class="nav nav-inline yamm">';
			...
			<div class="header-search">
				<form class="navbar-search" method="get" action="<?php echo esc_url( home_url( '/' ) ); ?>" autocomplete="off">
					<label class="sr-only screen-reader-text visually-hidden" for="mobile-search"><?php esc_html_e( 'Search for:', 'kintaelectric' ); ?></label>
					<div class="input-group">
						<div class="input-search-field">
							<input type="text" id="mobile-search" class="form-control search-field product-search-field" dir="ltr" value="" name="s" placeholder="<?php esc_attr_e( 'Search for Products', 'kintaelectric' ); ?>" autocomplete="off">
						</div>
						<div class="input-group-btn">
