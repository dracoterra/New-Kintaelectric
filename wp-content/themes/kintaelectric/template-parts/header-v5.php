                ...
                <div class="header-logo-area d-flex justify-content-between align-items-center">
                    ...
                    <div class="off-canvas-navigation-wrapper">
                        <div class="off-canvas-navigation">
                            <div class="off-canvas-navigation-inner">
                                <div class="off-canvas-navigation-header">
                                    <div class="off-canvas-navigation-header-title">
                                        <h3><?php esc_html_e( 'Menu', 'kintaelectric' ); ?></h3>
                                    </div>
                                    <div class="off-canvas-navigation-close">
                                        <button class="off-canvas-navigation-close-btn">
                                ...
                                <div class="off-canvas-navigation-content">
                                    ...
                                    wp_nav_menu( array(
                                        ...
                                        'menu_class'     => 'off-canvas-navigation-menu',
                                        'container'      => false,
                                        'fallback_cb'    => false,
                                    ) );
                                    ?>
                    ...
                    <div class="header-actions d-flex align-items-center">
                        ...
                        <div class="header-search-form">
                            <form role="search" method="get" class="search-form" action="<?php echo esc_url( home_url( '/' ) ); ?>">
                                <div class="input-group">
                                    <input type="search" class="form-control" placeholder="<?php esc_attr_e( 'Search for products...', 'kintaelectric' ); ?>" value="<?php echo get_search_query(); ?>" name="s" />
                        ...
                        <div class="header-icons d-flex align-items-center">
                            ...
                            <div class="header-icon">
                                <a href="<?php echo esc_url( wc_get_page_permalink( 'compare' ) ); ?>" class="header-icon-link">
                                    <i class="ec ec-compare"></i>
                                    <span class="header-icon-counter">0</span>
                                </a>
                            </div>
                            
                            <!-- Wishlist -->
                            <div class="header-icon">
                                <a href="<?php echo esc_url( wc_get_page_permalink( 'wishlist' ) ); ?>" class="header-icon-link">
                            ...
                            <div class="header-icon">
                                <a href="<?php echo esc_url( wc_get_cart_url() ); ?>" class="header-icon-link">
                                    ...
                                    <span class="header-icon-counter"><?php echo WC()->cart->get_cart_contents_count(); ?></span>
                                </a>
                            </div>
                        </div>
                    </div>
