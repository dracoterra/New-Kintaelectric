<?php
/**
 * Header v5 Template - Dynamic version
 * Based on header-v1.php, header-v2.php, header-v3.php and header-v4.php implementation
 * 
            ...
            <div class="masthead row align-items-center">
                ...
                <div class="primary-nav-menu col position-relative electro-animate-dropdown">
                    <ul id="menu-main-menu" class="nav nav-inline yamm">
                        <?php
                        // Primary Navigation Menu - using WordPress menu system
                        wp_nav_menu( array(
                            'theme_location' => 'primary',
                            'menu_class'     => 'nav nav-inline yamm',
                            'container'      => false,
                            'fallback_cb'    => 'kintaelectric_primary_fallback',
                            'depth'          => 3,
                            'walker'         => new KintaElectric_YAMM_Walker(),
                        ) );
                        ?>
                ...
                <div class="header-icons col-auto d-flex justify-content-end align-items-center">
                    ...
                    <div class="header-icon" data-bs-toggle="tooltip" data-bs-placement="bottom"
                        ...
                        <a href="<?php echo esc_url( YITH_WCWL()->get_wishlist_url() ); ?>">
                            ...
                            <span class="wishlist-count count header-icon-counter"><?php echo yith_wcwl_count_all_products(); ?></span>
                            <?php endif; ?>
                        </a>
                    </div>
                    <?php endif; ?>
                    ...
                    <div class="header-icon header-icon__user-account dropdown animate-dropdown"
                        ...
                        <a class="dropdown-toggle" href="<?php echo esc_url( wc_get_page_permalink( 'myaccount' ) ); ?>" data-bs-toggle="dropdown"><i class="ec ec-user"></i></a>
                                ...
                                <div class="widget woocommerce widget_product_search">
                                    <form role="search" method="get" class="woocommerce-product-search"
                                        ...
                                        <input type="search" id="woocommerce-product-search-field-0"
                                            class="search-field" placeholder="<?php esc_attr_e( 'Search products…', 'kintaelectric' ); ?>"
                                            value="" name="s">
