...
class Footer_Address_Widget extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		<div class="footer-address">
			<?php if ( ! empty( $instance['show_logo'] ) && $instance['show_logo'] ) : ?>
	...
	public function form( $instance ) {
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id( 'show_logo' ) ); ?>"><?php esc_attr_e( 'Display Logo', 'kintaelectric' ); ?></label>
		</p>
		<?php
	}
	...
	public function update( $new_instance, $old_instance ) {
		...
		$instance['show_logo'] = ( ! empty( $new_instance['show_logo'] ) ) ? (bool) $new_instance['show_logo'] : false;
		return $instance;
	}
}
